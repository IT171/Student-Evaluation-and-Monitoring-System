<?php
/*******************************************************************************
    test-bwPgSQL.php by Bill Weinman <http://bw.org/contact/>
...
function main()
{
    ...
    try {
        $db = new bwPgSQL(PGSQLUSER, PGSQLPASS, DATABASE, TABLE);
        message("initialized bwPgSQL version %s, connected to PostgreSQL server version %s", $db->version(), $db->version('pgsql'));
